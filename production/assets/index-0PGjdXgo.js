 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(t){function e(R,L){var b=R.length;R.push(L);e:for(;0<b;){var se=b-1>>>1,fe=R[se];if(0<i(fe,L))R[se]=L,R[b]=fe,b=se;else break e}}function n(R){return R.length===0?null:R[0]}function r(R){if(R.length===0)return null;var L=R[0],b=R.pop();if(b!==L){R[0]=b;e:for(var se=0,fe=R.length,Fs=fe>>>1;se<Fs;){var On=2*(se+1)-1,hl=R[On],xn=On+1,$s=R[xn];if(0>i(hl,b))xn<fe&&0>i($s,hl)?(R[se]=$s,R[xn]=b,se=xn):(R[se]=hl,R[On]=b,se=On);else if(xn<fe&&0>i($s,b))R[se]=$s,R[xn]=b,se=xn;else break e}}return L}function i(R,L){var b=R.sortIndex-L.sortIndex;return b!==0?b:R.id-L.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;t.unstable_now=function(){return s.now()}}else{var o=Date,a=o.now();t.unstable_now=function(){return o.now()-a}}var l=[],u=[],d=1,c=null,h=3,g=!1,_=!1,v=!1,E=typeof setTimeout=="function"?setTimeout:null,p=typeof clearTimeout=="function"?clearTimeout:null,f=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function m(R){for(var L=n(u);L!==null;){if(L.callback===null)r(u);else if(L.startTime<=R)r(u),L.sortIndex=L.expirationTime,e(l,L);else break;L=n(u)}}function y(R){if(v=!1,m(R),!_)if(n(l)!==null)_=!0,cl(C);else{var L=n(u);L!==null&&dl(y,L.startTime-R)}}function C(R,L){_=!1,v&&(v=!1,p(A),A=-1),g=!0;var b=h;try{for(m(L),c=n(l);c!==null&&(!(c.expirationTime>L)||R&&!ot());){var se=c.callback;if(typeof se=="function"){c.callback=null,h=c.priorityLevel;var fe=se(c.expirationTime<=L);L=t.unstable_now(),typeof fe=="function"?c.callback=fe:c===n(l)&&r(l),m(L)}else r(l);c=n(l)}if(c!==null)var Fs=!0;else{var On=n(u);On!==null&&dl(y,On.startTime-L),Fs=!1}return Fs}finally{c=null,h=b,g=!1}}var k=!1,P=null,A=-1,B=5,D=-1;function ot(){return!(t.unstable_now()-D<B)}function oi(){if(P!==null){var R=t.unstable_now();D=R;var L=!0;try{L=P(!0,R)}finally{L?ai():(k=!1,P=null)}}else k=!1}var ai;if(typeof f=="function")ai=function(){f(oi)};else if(typeof MessageChannel<"u"){var Ph=new MessageChannel,Zw=Ph.port2;Ph.port1.onmessage=oi,ai=function(){Zw.postMessage(null)}}else ai=function(){E(oi,0)};function cl(R){P=R,k||(k=!0,ai())}function dl(R,L){A=E(function(){R(t.unstable_now())},L)}t.unstable_IdlePriority=5,t.unstable_ImmediatePriority=1,t.unstable_LowPriority=4,t.unstable_NormalPriority=3,t.unstable_Profiling=null,t.unstable_UserBlockingPriority=2,t.unstable_cancelCallback=function(R){R.callback=null},t.unstable_continueExecution=function(){_||g||(_=!0,cl(C))},t.unstable_forceFrameRate=function(R){0>R||125<R?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):B=0<R?Math.floor(1e3/R):5},t.unstable_getCurrentPriorityLevel=function(){return h},t.unstable_getFirstCallbackNode=function(){return n(l)},t.unstable_next=function(R){switch(h){case 1:case 2:case 3:var L=3;break;default:L=h}var b=h;h=L;try{return R()}finally{h=b}},t.unstable_pauseExecution=function(){},t.unstable_requestPaint=function(){},t.unstable_runWithPriority=function(R,L){switch(R){case 1:case 2:case 3:case 4:case 5:break;default:R=3}var b=h;h=R;try{return L()}finally{h=b}},t.unstable_scheduleCallback=function(R,L,b){var se=t.unstable_now();switch(typeof b=="object"&&b!==null?(b=b.delay,b=typeof b=="number"&&0<b?se+b:se):b=se,R){case 1:var fe=-1;break;case 2:fe=250;break;case 5:fe=1073741823;break;case 4:fe=1e4;break;default:fe=5e3}return fe=b+fe,R={id:d++,callback:L,priorityLevel:R,startTime:b,expirationTime:fe,sortIndex:-1},b>se?(R.sortIndex=b,e(u,R),n(l)===null&&R===n(u)&&(v?(p(A),A=-1):v=!0,dl(y,b-se))):(R.sortIndex=fe,e(l,R),_||g||(_=!0,cl(C))),R},t.unstable_shouldYield=ot,t.unstable_wrapCallback=function(R){var L=h;return function(){var b=h;h=L;try{return R.apply(this,arguments)}finally{h=b}}}})(zm);$m.exports=zm;var T0=$m.exports;/**
 * @license React
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function C1(t=qa()){const e=qt(t,"auth");if(e.isInitialized())return e.getImmediate();const n=i1(t,{persistence:[w1]}),r=Rd("auth");return r&&o1(n,`http://${r}`),n}S1("WebExtension");function $d(){const t=C1(Ns),e=Td(),[n,r]=S.useState(!1),[i,s]=S.useState(),[o,a]=S.useState();return S.useEffect(()=>{const l=Xv(t,u=>{u?(s(u.photoURL),r(!0),a(u.displayName)):e("/")});return()=>l()}),S.useEffect(()=>{console.log(o)},[o]),N.jsx(N.Fragment,{children:N.jsxs("div",{className:"navbar",children:[N.jsx("div",{className:"logo",children:"DORO"}),N.jsxs("div",{className:"nav",children:[N.jsx("a",{href:"/ ",children:N.jsx("div",{children:"Home"})}),N.jsx("a",{href:"/songs",children:N.jsx("div",{children:"Spotify"})}),N.jsx("a",{href:"",children:N.jsx("div",{children:"Sessions"})})]}),"(",n?N.jsxs("a",{href:"/login",children:[N.jsx("div",{className:"user",children:N.jsx("img",{src:i})}),N.jsx("p",{style:{color:"white",textDecoration:"none"},children:o})]}):N.jsx("a",{href:"/login",children:N.jsx("div",{className:"user",children:N.jsx("img",{src:"src/assets/user.png"})})}),")"]})})}function T1(){return N.jsx(N.Fragment,{children:N.jsxs("div",{className:"container",children:[N.jsx($d,{}),N.jsxs("div",{className:"base",children:[N.jsx("div",{className:"bottom"}),N.jsxs("div",{className:"main",children:[N.jsx("div",{className:"text",children:"Start tracking your time today and see the difference"}),N.jsx(NS,{to:"dashboard",children:N.jsx("div",{className:"start",children:"START NOW "})})]})]})]})})}function sy(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const k1=sy,oy=new kt("auth","Firebase",sy());/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
